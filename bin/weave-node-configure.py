...
import plugins.weave.WeaveNodeConfigure
from happy.Utils import *

if __name__ == "__main__":
    options = plugins.weave.WeaveNodeConfigure.option()
    ...
    try:
        ...
        print plugins.weave.WeaveNodeConfigure.WeaveNodeConfigure.__doc__
        print hred(str(err))
    ...
    cmd = plugins.weave.WeaveNodeConfigure.WeaveNodeConfigure(options)
    cmd.run()
