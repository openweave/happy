...
import plugins.weave.WeaveNetworkGateway
from happy.Utils import *

if __name__ == "__main__":
    options = plugins.weave.WeaveNetworkGateway.option()
    ...
    try:
        ...
        print plugins.weave.WeaveNetworkGateway.WeaveNetworkGateway.__doc__
        print hred(str(err))
    ...
    cmd = plugins.weave.WeaveNetworkGateway.WeaveNetworkGateway(options)
    cmd.start()
