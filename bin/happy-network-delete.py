...
##
#    @file
#       A Happy command line utility that deletes weave network.
#
#       The command is executed by instantiating and running HappyNetworkDelete class.
#
...
if __name__ == "__main__":
    ...
    try:
        ...
        print happy.HappyNetworkDelete.HappyNetworkDelete.__doc__
        print hred(str(err))
